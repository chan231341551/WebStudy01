...
<body>
	...
	<pre>
		session(server) vs cookie(client)
			: http 의 stateless 특성으로 인해 커뮤니케이션 정보가 유지되지 않는 경우,
			사용하는 저장소의 개념.
...
// 			domainCookie.setDomain("www.naver.com");
// 			response.addCookie(domainCookie);
		...
		<%--
			...
			String findedValue = new CookieHttpServletRequestWrapper(request).getCookieValue("koreanCookie");//어댑터 
