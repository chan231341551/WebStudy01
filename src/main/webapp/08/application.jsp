...
<pre>
	...
	(Servlet container[WAS,JSP container] 와 커퓨니케이션 하기 위한 개체)
	...
	3. logging <% application.log("정상 로그 메세지"); %>
	4(*****). 현재 컨텍스트의 웹리소스 획득
		<%
			...
			File destFile = new File(saveFolderPath, imageFile.getName()); // 물리경로 , 복사할 파일이름
			try(
